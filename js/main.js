...
(function ($) {
    ...
    CRUMINA.TopSearch = function () {
        $('.js-user-search').selectize({
            ...
            searchField: ['name'],
            options: [
                {image: 'img/avatar30-sm.jpg', name: 'Marie Claire Stevens', message:'12 Friends in Common', icon:'twinz-happy-face-icon'},
                {image: 'img/avatar54-sm.jpg', name: 'Marie Davidson', message:'4 Friends in Common', icon:'twinz-happy-face-icon'},
                {image: 'img/avatar49-sm.jpg', name: 'Marina Polson', message:'Mutual Friend: Mathilda Brinker', icon:'twinz-happy-face-icon'},
                {image: 'img/avatar36-sm.jpg', name: 'Ann Marie Gibson', message:'New York, NY', icon:'twinz-happy-face-icon'},
                {image: 'img/avatar22-sm.jpg', name: 'Dave Marinara', message:'8 Friends in Common', icon:'twinz-happy-face-icon'},
                {image: 'img/avatar41-sm.jpg', name: 'The Marina Bar', message:'Restaurant / Bar', icon:'twinz-star-icon'}
            ],
            render: {
    ...
    * Input Number Quantity
	 ...
	 * ---------------------------*/
	 ...
	 $('.js-notification-open').on('click', function () {
	    $(this).siblings('.more-dropdown').css({
	       opacity: '1',
	       visibility: 'visible'
	    });
	    $(this).siblings('.more-dropdown') .blur(function(){
	       $(this).css({
	          opacity: '0',
	          visibility: 'hidden'
	       });
